...
smtp_credentials = MultiJson.load(IO.popen(['op', 'get', 'item', '--fields', 'username,password',
                                            'ktpvkiv2xjdh3chdpbil66llri']).read)
...
Mail.deliver do
  ...
  html_part do
    ...
    body Redcarpet::Markdown.new(Redcarpet::Render::HTML).render(format(File.read('README.md'), email_url: email_url))
  end
end
